...
class CreateLotWrWeightFinishProductsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('lot_wr_weight_finish_products', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('lot_wr_weight_finish_products');
    }
}
