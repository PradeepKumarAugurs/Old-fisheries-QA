            ...
            <div class="row">
                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-pane @if(!Session::has('tab')) active @endif" id="tab_1">
                        <form action="{{ url('accountmanagement/updateProducer') }}" id="basicInfoForm" method="post" enctype="multipart/form-data">
                        @csrf 
                        <h4>Producer Info </h4>
                        @if(isset($getProducer->id))
                        <input type="hidden" name="row_id" value="{{ $getProducer->id }}" />
                        @else 
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" value="{{ $getProducer->name }}"  class="@error('name') is-invalid @enderror form-control">
                                            @error('name')
                                    ...
                                    <div class="col-md-2" >
                                        @if(isset($getProducer->profileImage->file) && $getProducer->profileImage->file!="") 
                                           <img src="{{asset('userImages/'.$getProducer->profileImage->file)}}"  alt="image path not found " srcset="" style="height:100px; width: 80px;">
                                        @endif
                                    </div>
                                </div> <!--  END Row -->
                                <div class="row">
                                    <div class="col-md-12">
                                        <table class="table table-hover table-border">
                                          ...
                                          <tbody>
                                            <tr>
                                                <td> 
                                                    <input type="text"  value="{{ $getProducer->code }}"  name="code" class="form-control @error('code') is-invalid @enderror">
                                                    @error('code')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <td> 
                                                <input type="text"   value="{{ $getProducer->alpha_code }}" name="alpha_code" class="@error('alpha_code') is-invalid @enderror form-control">
                                                @error('alpha_code')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <table class="table table-hover table-border">
                                        ...
                                        <td>
                                        <select name="country" id="country" class="form-control @error('country') is-invalid @enderror getCitiesByAjax">
                                            <option value="">-- Select Country --</option>
                                            @if(isset($getAllCountries) && count($getAllCountries))
                                                @foreach($getAllCountries as $country)
                                                    <option value="{{$country->id}}" {{ $getProducer->country_id == $country->id ? 'selected' : ''}}>{{$country->name}}</option>
                                                @endforeach
                                        ...
                                        <td>
                                        <select name="city" id="city" value="{{ $getProducer->city }}" class="form-control @error('city') is-invalid @enderror">
                                        <option value="">-- Select City --</option>
                                            

                                            @if(isset($getProducer->country_id))
                                            @foreach(Modules\AccountManagement\Entities\City::where('country_id',$getProducer->country_id)->get() as $value)
                                               <option value="{{$value->id}}" {{ $getProducer->city_id == $value->id ? 'selected' : ''}} >{{$value->name}}</option>
                                            @endforeach
                                            @elseif(old('country'))
                                            @foreach(Modules\AccountManagement\Entities\City::where('country_id',old('country'))->get() as $value)
                                               <option value="{{$value->id}}" {{ $producer->city_id == $value->id ? 'selected' : ''}} >{{$value->name}}</option>
                                            @endforeach
                                            @endif 
                                        </select>
                                        @error('city')
                                        ...
                                        <td>
                                        <input type="text" name="address" value="{{ $getProducer->address }}" class="form-control @error('address') is-invalid @enderror">
                                        @error('address')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="row"> 
                                <div class="col-md-12">
                                    <table class="table table-hover table-border">
                                        <thead>
                                        <tr>
                                        <th class="info">User having access to this producer {{count($getProducer->producer_access)}}</th>
                                        ...
                                        <td>
                                           <div class="form-group">
                                                <select  class="form-control @error('producerAccess.user_id.0') is-invalid @enderror " name="producerAccess[user_id][]">
                                                    ...
                                                    <option value="{{$producer->id}}" @if(isset($getProducer->producer_access) && ( count($getProducer->producer_access) > 0 ) && $getProducer->producer_access[0]->user_id==$producer->id) selected @endif >{{($producer->name=="")?ucfirst($producer->username):ucfirst($producer->name)}}</option> 
                                                    @endforeach
                                                    @endif 
                                                </select>
                                           ...
                                           <div class="form-group">
                                                <select  class="form-control @error('producerAccess.user_id.1') is-invalid @enderror " name="producerAccess[user_id][]">
                                                    ...
                                                    @if(isset($getAllProducerUser) && count($getAllProducerUser))
                                                    @foreach($getAllProducerUser as $producer)
                                                    <option value="{{$producer->id}}" @if(isset($getProducer->producer_access)  && ( count($getProducer->producer_access) > 0 ) && $getProducer->producer_access[1]->user_id==$producer->id) selected @endif >{{($producer->name=="")?ucfirst($producer->username):ucfirst($producer->name)}}</option> 
                                                    @endforeach
                                                    @endif  
                                                </select>
                                           ...
                                           <div class="form-group">
                                                <select  class="form-control @error('producerAccess.user_id.2') is-invalid @enderror " name="producerAccess[user_id][]">
                                                    ...
                                                    @if(isset($getAllProducerUser) && count($getAllProducerUser))
                                                    @foreach($getAllProducerUser as $producer)
                                                    <option value="{{$producer->id}}" @if(isset($getProducer->producer_access)  && ( count($getProducer->producer_access) > 0 ) && $getProducer->producer_access[2]->user_id==$producer->id) selected @endif >{{($producer->name=="")?ucfirst($producer->username):ucfirst($producer->name)}}</option> 
                                                    @endforeach
                                                    @endif 
                                                </select>
                                        ...
                                        <td> 
                                            <div class="form-group">
                                                ...
                                                <select  class="form-control @error('leader_id') is-invalid @enderror " name="leader_id">
                                                    ...
                                                    @if(isset($getAllProducerUser) && count($getAllProducerUser))
                                                    @foreach($getAllProducerUser as $producer)
                                                    <option value="{{$producer->id}}"  @if(isset($getProducer->leader_id) && $getProducer->leader_id==$producer->id) selected @endif >{{($producer->name=="")?ucfirst($producer->username):ucfirst($producer->name)}}</option> 
                                                    @endforeach
                                                    @endif 
                                                </select>
                                                @error('leader_id')
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select  class="form-control @error('producer_type') is-invalid @enderror " name="producer_type">
                                                    ...
                                                    <option @if(isset($getProducer->producer_type) && $getProducer->producer_type=='1') selected @elseif(old('producer_type')=='1') selected @endif  value="1" >Landbased</option>
                                                    <option @if(isset($getProducer->producer_type) && $getProducer->producer_type=='2') selected @elseif(old('producer_type')=='2') selected @endif value="2">Onboard Processing</option>
                                                </select>
                                                @error('producer_type')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="row">
                                <div class="col-md-11 table-responsive">
                                        <table  id="fishing-table" class="table table-border table-striped">
                                            <thead>
                                            <tr class="info" >
                                            @if(isset($sections[0]->custom_fields) && count($sections[0]->custom_fields))
                                                @foreach($sections[0]->custom_fields as $key =>$column)
                                                <th>
                                                <input type="text" name="sections[0][custom_fields][name][]" value="@if(old('sections.0.custom_fields.name.{{$key}}')) {{old('sections.0.custom_fields.name.$key')}} @else {{$column->name}} @endif" class="form-control @error('sections.0.custom_fields.name.{{$key}}') is-invalid @enderror ">
                                                <input type="hidden" name="sections[0][custom_fields][type][]" value="@if(old('sections.0.custom_fields.type.{{$key}}')) {{old('sections.0.custom_fields.type.$key')}} @else 4 @endif" class="form-control">
                                                <input type="hidden" name="sections[0][custom_fields][item_list][]" value="@if(old('sections.0.custom_fields.item_list.{{$key}}')) {{old('sections.0.custom_fields.item_list.$key')}} @else a,b,c @endif" class="form-control">
                                                </th>
                                                @endforeach
                                            @else 
                                                <th>
                                            ...
                                            <thead>
                                            <tbody>
                                            @if(isset($sections[0]->custom_rows) && count($sections[0]->custom_rows))
                                                @foreach($sections[0]->custom_rows as $key=>$customRow)
                                                

                                                    @if($key=='0')
                                                    <tr>
                                                        @if(isset($customRow->customdata) && count($customRow->customdata))
                                                            @foreach($customRow->customdata as $keyOfCustomColumn=>$customdata)
                                                                <td> 
                                                                <input type="text" class="form-control @error('sections.0.custom_rows.customdata.{{$keyOfCustomColumn}}.value.0') is-invalid @enderror" name="sections[0][custom_rows][customdata][{{$keyOfCustomColumn}}][value][]" value="{{$customdata->value}}"> 
                                                                </td>
                                                            @endforeach
                                                        @endif 
                                                    ...
                                                    <tr>
                                                        @if(isset($customRow->customdata) && count($customRow->customdata))
                                                            @foreach($customRow->customdata as $keyOfCustomColumn=>$customdata)
                                                                @if($keyOfCustomColumn=='0')
                                                                <td>
                                                                    <select  class="form-control @error('sections.0.custom_rows.customdata.0.value.1') is-invalid @enderror" name="sections[0][custom_rows][customdata][{{$keyOfCustomColumn}}][value][]" >
                                                                        <option value="">-- Select vessels--</option>
                                                                        @if(isset($getVesselList) && count($getVesselList))
                                                                        @foreach($getVesselList as $vessel)
                                                                            <option value="{{$vessel->id}}" @if(isset($customdata->value) && $customdata->value==$vessel->id) selected @endif >{{$vessel->vessel_name}}</option>
                                                                        @endforeach
                                                                        @endif 
                                                                    </select>
                                                                </td>
                                                                @elseif($keyOfCustomColumn=='1' ||  $keyOfCustomColumn=='2' ||  $keyOfCustomColumn=='3')
                                                                <td><input type="checkbox" name="sections[0][custom_rows][customdata][{{$keyOfCustomColumn}}][value][]" @if(isset($customdata->value) && $customdata->value =='1') checked @endif value="1" class="minimal @error('sections.0.custom_rows.customdata.1.value.1') is-invalid @enderror" ></td>
                                                                @else 
                                                                <td><input type="text" name="sections[0][custom_rows][customdata][{{$keyOfCustomColumn}}][value][]" class="form-control @error('sections.0.custom_rows.customdata.{{$keyOfCustomColumn}}.value.0') is-invalid @enderror" value="{{$customdata->value}}">  </td>
                                                                @endif 
                                                            @endforeach
                                                        @endif 
                                                    </tr>
                                ...
                                <div class="col-md-6">
                                        ...
                                        <label for="fao_fishing_zone">FAO Fising Zone</label>
                                            <select class="form-control @error('fao_fishing_zone') is-invalid @enderror" name="fao_fishing_zone">
                                                <option @if(isset($getProducer->fao_fishing_zone) && $getProducer->fao_fishing_zone=='') selected @endif value="">-- Select Fishing Zone --</option>
                                                
                                                <option @if(isset($getProducer->fao_fishing_zone) && $getProducer->fao_fishing_zone=='1') selected @endif value="1">Area 18 (Arctic Sea)</option>
                                                <option @if(isset($getProducer->fao_fishing_zone) && $getProducer->fao_fishing_zone=='2') selected @endif value="2">Area 21 (Atlantic, Northwest)</option>
                                                <option @if(isset($getProducer->fao_fishing_zone) && $getProducer->fao_fishing_zone=='3') selected @endif value="3">Area 27 (Atlantic, Northeast)</option>
                                                <option @if(isset($getProducer->fao_fishing_zone) && $getProducer->fao_fishing_zone=='4') selected @endif value="4">Area 31 ( Atlantic, Western Central)</option>
                                                <option @if(isset($getProducer->fao_fishing_zone) && $getProducer->fao_fishing_zone=='5') selected @endif value="5">Area 34 (Atlantic, Eastern Central)</option>
                                                <option @if(isset($getProducer->fao_fishing_zone) && $getProducer->fao_fishing_zone=='6') selected @endif value="6">Area 37 (Mediterranean and Black Sea)</option>
                                                <option @if(isset($getProducer->fao_fishing_zone) && $getProducer->fao_fishing_zone=='7') selected @endif value="7">Area 41 (Atlantic, Southwest)</option>
                                                <option @if(isset($getProducer->fao_fishing_zone) && $getProducer->fao_fishing_zone=='8') selected @endif value="8">Area 47 (Atlantic, Southeast)</option>
                                                <option @if(isset($getProducer->fao_fishing_zone) && $getProducer->fao_fishing_zone=='9') selected @endif value="9">Area 48 (Atlantic, Antarctic)</option>
                                                <option @if(isset($getProducer->fao_fishing_zone) && $getProducer->fao_fishing_zone=='10') selected @endif value="10">Area 51 ( Indian Ocean, Western)</option>
                                                <option @if(isset($getProducer->fao_fishing_zone) && $getProducer->fao_fishing_zone=='11') selected @endif value="11">Area 57 (Indian Ocean, Eastern)</option>
                                                <option @if(isset($getProducer->fao_fishing_zone) && $getProducer->fao_fishing_zone=='12') selected @endif value="12">Area 58 (Indian Ocean, Antarctic and Southern)</option>
                                                <option @if(isset($getProducer->fao_fishing_zone) && $getProducer->fao_fishing_zone=='13') selected @endif value="13">Area 61 (Pacific, Northwest)</option>
                                                <option @if(isset($getProducer->fao_fishing_zone) && $getProducer->fao_fishing_zone=='14') selected @endif value="14">Area 67 (Pacific, Northeast)</option>
                                                <option @if(isset($getProducer->fao_fishing_zone) && $getProducer->fao_fishing_zone=='15') selected @endif value="15">Area 71 (Pacific, Western Central)</option>
                                                <option @if(isset($getProducer->fao_fishing_zone) && $getProducer->fao_fishing_zone=='16') selected @endif value="16">Area 77 (Pacific, Eastern Central)</option>
                                                <option @if(isset($getProducer->fao_fishing_zone) && $getProducer->fao_fishing_zone=='17') selected @endif value="17">Area 81 (Pacific, Southwest)</option>
                                                <option @if(isset($getProducer->fao_fishing_zone) && $getProducer->fao_fishing_zone=='18') selected @endif value="18">Area 87 (Pacific, Southeast)</option>
                                                <option @if(isset($getProducer->fao_fishing_zone) && $getProducer->fao_fishing_zone=='19') selected @endif value="19">Area 88 (Pacific, Antarctic)</option>
                                            </select>
                            ...
                            <div class="row">
                                ...
                                <table id="unloading-table" class="table table-border table-striped">
                                            <thead>
                                            <tr class="info">
                                            @if(isset($sections[1]->custom_fields) && count($sections[1]->custom_fields))
                                                @foreach($sections[1]->custom_fields as $key =>$column)
                                                <th>
                                                <input type="text" name="sections[1][custom_fields][name][]" value="@if(old('sections.1.custom_fields.name.{{$key}}')) {{old('sections.1.custom_fields.name.$key')}} @else {{$column->name}} @endif" class="form-control @error('sections.1.custom_fields.name.{{$key}}') is-invalid @enderror ">
                                                <input type="hidden" name="sections[1][custom_fields][type][]" value="@if(old('sections.1.custom_fields.type.{{$key}}')) {{old('sections.1.custom_fields.type.$key')}} @else {{$column->type?$column->type:''}} @endif" class="form-control">
                                                <input type="hidden" name="sections[1][custom_fields][item_list][]" value="@if(old('sections.1.custom_fields.item_list.{{$key}}')) {{old('sections.1.custom_fields.item_list.$key')}} @else NULL @endif" class="form-control">
                                                </th>
                                                @endforeach
                                            @else 
                                                <th>
                                            ...
                                            <tbody>
                                            @if(isset($sections[1]->custom_rows) && count($sections[1]->custom_rows))
                                                @foreach($sections[1]->custom_rows as $key=>$customRow)
                                                <tr>
                                                    @if(isset($customRow->customdata) && count($customRow->customdata))
                                                        @foreach($customRow->customdata as $keyOfCustomColumn=>$customdata)
                                                            @if($keyOfCustomColumn=='1')
                                                            <td> <select class="form-control" name="sections[1][custom_rows][customdata][{{$keyOfCustomColumn}}][value][]">
                                                                <option @if(isset($customdata->value) && $customdata->value=='') selected @endif value="">-- Select Unloading Type--</option>
                                                                <option @if(isset($customdata->value) && $customdata->value=='1') selected @endif value="1">Positive Pressure</option>
                                                                <option @if(isset($customdata->value) && $customdata->value=='2') selected @endif value="2">Peristaltic</option>
                                                                <option @if(isset($customdata->value) && $customdata->value=='3') selected @endif value="3">Brail</option>
                                                                <option @if(isset($customdata->value) && $customdata->value=='4') selected @endif value="4">Transvac Type</option>
                                                                <option @if(isset($customdata->value) && $customdata->value=='5') selected @endif value="5">Manual</option>
                                                                </select>
                                                            </td>
                                                            @else
                                                            <td><input type="text" name="sections[1][custom_rows][customdata][{{$keyOfCustomColumn}}][value][]" value="{{$customdata->value?$customdata->value:''}}" class="form-control" > </td>
                                                            @endif
                                                        @endforeach
                                                    @endif 
                            ...
                            <div class="row">
                                ...
                                <table id="storageAtReception-table" class="table table-border table-striped">
                                            <thead>
                                                <tr class="info">
                                                @if(isset($sections[2]->custom_fields) && count($sections[2]->custom_fields))
                                                    @foreach($sections[2]->custom_fields as $key =>$column)
                                                    <th>
                                                    <input type="text" name="sections[2][custom_fields][name][]" value="@if(old('sections.2.custom_fields.name.{{$key}}')) {{old('sections.2.custom_fields.name.$key')}} @else {{$column->name}} @endif" class="form-control @error('sections.2.custom_fields.name.{{$key}}') is-invalid @enderror ">
                                                    <input type="hidden" name="sections[2][custom_fields][type][]" value="@if(old('sections.2.custom_fields.type.{{$key}}')) {{old('sections.2.custom_fields.type.$key')}} @else {{$column->type?$column->type:''}} @endif" class="form-control">
                                                    <input type="hidden" name="sections[2][custom_fields][item_list][]" value="@if(old('sections.2.custom_fields.item_list.{{$key}}')) {{old('sections.2.custom_fields.item_list.$key')}} @else NULL @endif" class="form-control">
                                                    </th>
                                                    @endforeach
                                                @else
                                                    <th>                                                                                        
                                            ...
                                            <tbody>
                                            @if(isset($sections[2]->custom_rows) && count($sections[2]->custom_rows))
                                                @foreach($sections[2]->custom_rows as $key=>$customRow)
                                                <tr>
                                                    @if(isset($customRow->customdata) && count($customRow->customdata))
                                                        @foreach($customRow->customdata as $keyOfCustomColumn=>$customdata)
                                                            @if($keyOfCustomColumn=='2')
                                                            <td>
                                                                <select class="form-control" name="sections[2][custom_rows][customdata][{{$keyOfCustomColumn}}][value][]">
                                                                    <option @if(isset($customdata->value) && $customdata->value=='') selected @endif value="">-- Select --</option>
                                                                    <option @if(isset($customdata->value) && $customdata->value=='1') selected @endif value="1">Totes</option>
                                                                    <option @if(isset($customdata->value) && $customdata->value=='2') selected @endif value="2">Pool</option>
                                                                    <option @if(isset($customdata->value) && $customdata->value=='3') selected @endif value="3">Dry</option>
                                                                </select>
                                                            </td>
                                                            @else
                                                            <td><input type="text" name="sections[2][custom_rows][customdata][{{$keyOfCustomColumn}}][value][]" value="{{$customdata->value?$customdata->value:''}}" class="form-control" > </td>
                                                            @endif
                                                        @endforeach
                                                    @endif 
                                            ...
                                            <tfoot>
                                                <tr class="info">
                                                    <th>Total</th>
                                                    <th><input type="text" name="total_capacity_of_storage_reception" value="{{$getProducer->total_capacity_of_storage_reception?$getProducer->total_capacity_of_storage_reception:'4234'}}" class="form-control @error('total_capacity_of_storage_reception') is-invalid @enderror"></th>
                                                    <th></th>
                                                </tr>
                                            </tfoot>
                                        </table>
                            ...
                            <div class="row">
                                ...
                                <table  id="iceSupply-table" class="table table-border table-striped">
                                            <thead>
                                            <tr class="info">
                                                @if(isset($sections[3]->custom_fields) && count($sections[3]->custom_fields))
                                                    @foreach($sections[3]->custom_fields as $key =>$column)
                                                    <th>
                                                    <input type="text" name="sections[3][custom_fields][name][]" value="@if(old('sections.3.custom_fields.name.{{$key}}')) {{old('sections.3.custom_fields.name.$key')}} @else {{$column->name}} @endif" class="form-control @error('sections.3.custom_fields.name.{{$key}}') is-invalid @enderror ">
                                                    <input type="hidden" name="sections[3][custom_fields][type][]" value="@if(old('sections.3.custom_fields.type.{{$key}}')) {{old('sections.3.custom_fields.type.$key')}} @else {{$column->type?$column->type:''}} @endif" class="form-control">
                                                    <input type="hidden" name="sections[3][custom_fields][item_list][]" value="@if(old('sections.3.custom_fields.item_list.{{$key}}')) {{old('sections.3.custom_fields.item_list.$key')}} @else NULL @endif" class="form-control">
                                                    </th>
                                                    @endforeach
                                                @else
                                                <th>
                                            ...
                                            <tbody>
                                            @if(isset($sections[3]->custom_rows) && count($sections[3]->custom_rows))
                                                @foreach($sections[3]->custom_rows as $key=>$customRow)
                                                <tr>
                                                    @if(isset($customRow->customdata) && count($customRow->customdata))
                                                        @foreach($customRow->customdata as $keyOfCustomColumn=>$customdata)
                                                            @if($keyOfCustomColumn=='0')
                                                            <td>
                                                                <select class="form-control" name="sections[3][custom_rows][customdata][{{$keyOfCustomColumn}}][value][]">
                                                                    <option @if(isset($customdata->value) && $customdata->value=='') selected @endif value="">-- Select --</option> 
                                                                    <option @if(isset($customdata->value) && $customdata->value=='1') selected @endif value="1">other</option>
                                                                    <option @if(isset($customdata->value) && $customdata->value=='2') selected @endif value="2">Own</option>
                                                                    <option @if(isset($customdata->value) && $customdata->value=='3') selected @endif value="3">third-party</option>
                                                                </select>
                                                            </td>
                                                            @elseif($keyOfCustomColumn=='2')
                                                            <td>
                                                                <select class="form-control" name="sections[3][custom_rows][customdata][{{$keyOfCustomColumn}}][value][]">
                                                                    <option @if(isset($customdata->value) && $customdata->value=='') selected @endif value="">-- Select --</option> 
                                                                    <option @if(isset($customdata->value) && $customdata->value=='1') selected @endif value="1">other</option>
                                                                    <option @if(isset($customdata->value) && $customdata->value=='2') selected @endif value="2">slurry</option>
                                                                    <option @if(isset($customdata->value) && $customdata->value=='3') selected @endif value="3">crush bar</option>
                                                                    <option @if(isset($customdata->value) && $customdata->value=='4') selected @endif value="4">flake</option>
                                                                </select>
                                                            </td>
                                                            @else
                                                            <td><input type="text" name="sections[2][custom_rows][customdata][{{$keyOfCustomColumn}}][value][]" value="{{$customdata->value?$customdata->value:''}}" class="form-control" > </td>
                                            ...
                                            <tr>
                                                ...
                                                <td> 
                                                    <select class="form-control" name="sections[3][custom_rows][customdata][2][value][]">
                                                        <option value="">-- Select --</option> 
                                                        <option value="1">other</option>
                            ...
                            <div class="row">
                                ...
                                <table  id="gradding-table" class="table table-border table-striped">
                                            <thead>
                                            <tr class="info">
                                                @if(isset($sections[4]->custom_fields) && count($sections[4]->custom_fields))
                                                    @foreach($sections[4]->custom_fields as $key =>$column)
                                                    <th>
                                                    <input type="text" name="sections[4][custom_fields][name][]" value="@if(old('sections.4.custom_fields.name.{{$key}}')) {{old('sections.4.custom_fields.name.$key')}} @else {{$column->name}} @endif" class="form-control @error('sections.4.custom_fields.name.{{$key}}') is-invalid @enderror ">
                                                    <input type="hidden" name="sections[4][custom_fields][type][]" value="@if(old('sections.4.custom_fields.type.{{$key}}')) {{old('sections.4.custom_fields.type.$key')}} @else {{$column->type?$column->type:''}} @endif" class="form-control">
                                                    <input type="hidden" name="sections[4][custom_fields][item_list][]" value="@if(old('sections.4.custom_fields.item_list.{{$key}}')) {{old('sections.4.custom_fields.item_list.$key')}} @else NULL @endif" class="form-control">
                                                    </th>
                                                    @endforeach
                                                @else
                                                <th>
                                            ...
                                            <tbody>
                                            @if(isset($sections[4]->custom_rows) && count($sections[4]->custom_rows))
                                                @foreach($sections[4]->custom_rows as $key=>$customRow)
                                                <tr>
                                                    @if(isset($customRow->customdata) && count($customRow->customdata))
                                                        @foreach($customRow->customdata as $keyOfCustomColumn=>$customdata)
                                                            @if($keyOfCustomColumn=='1')
                                                            <td>
                                                                <select class="form-control" name="sections[4][custom_rows][customdata][{{$keyOfCustomColumn}}][value][]">
                                                                    <option @if(isset($customdata->value) && $customdata->value=='') selected @endif value="">-- Select --</option>
                                                                    <option @if(isset($customdata->value) && $customdata->value=='1') selected @endif value="1">Roller Gradder</option>
                                                                    <option @if(isset($customdata->value) && $customdata->value=='2') selected @endif value="2">Belt Gradder</option>
                                                                    <option @if(isset($customdata->value) && $customdata->value=='3') selected @endif value="3">Weight Gradder</option>
                                                                </select>
                                                            </td>
                                                            @else
                                                            <td><input type="text" name="sections[4][custom_rows][customdata][{{$keyOfCustomColumn}}][value][]" value="{{$customdata->value?$customdata->value:''}}" class="form-control" > </td>
                                                            @endif
                                                        @endforeach
                                                    @endif 
                                            ...
                                            <tfoot>
                                                <tr class="info">
                                                    <th>Total</th>
                                                    <th></th>
                                                    <th><input type="text" name="total_grading_capacity" value="{{$getProducer->total_grading_capacity?$getProducer->total_grading_capacity:'4234'}}" class="form-control"></th>
                                                    <th></th>
                                                </tr>
                                            </tfoot>
                                        </table>
                            ...
                            <div class="row">
                                ...
                                <table  id="wrProcessing-table" class="table table-border table-striped">
                                            <thead>
                                            <tr class="info">
                                                @if(isset($sections[5]->custom_fields) && count($sections[5]->custom_fields))
                                                    @foreach($sections[5]->custom_fields as $key =>$column)
                                                    <th>
                                                    <input type="text" name="sections[5][custom_fields][name][]" value="@if(old('sections.5.custom_fields.name.{{$key}}')) {{old('sections.5.custom_fields.name.$key')}} @else {{$column->name}} @endif" class="form-control @error('sections.5.custom_fields.name.{{$key}}') is-invalid @enderror ">
                                                    <input type="hidden" name="sections[5][custom_fields][type][]" value="@if(old('sections.5.custom_fields.type.{{$key}}')) {{old('sections.5.custom_fields.type.$key')}} @else {{$column->type?$column->type:''}} @endif" class="form-control">
                                                    <input type="hidden" name="sections[5][custom_fields][item_list][]" value="@if(old('sections.5.custom_fields.item_list.{{$key}}')) {{old('sections.5.custom_fields.item_list.$key')}} @else NULL @endif" class="form-control">
                                                    </th>
                                                    @endforeach
                                                @else
                                                <th>      
                                            ...
                                            <tbody>
                                            @if(isset($sections[5]->custom_rows) && count($sections[5]->custom_rows))
                                                @foreach($sections[5]->custom_rows as $key=>$customRow)
                                                <tr>
                                                    @if(isset($customRow->customdata) && count($customRow->customdata))
                                                        @foreach($customRow->customdata as $keyOfCustomColumn=>$customdata)
                                                            <td><input type="text" name="sections[5][custom_rows][customdata][{{$keyOfCustomColumn}}][value][]" value="{{$customdata->value?$customdata->value:''}}" class="form-control" > </td>
                                                        @endforeach
                                                    @endif 
                                                </tr>
                                                @endforeach
                                            ...
                                            <tfoot>
                                                <tr class="info">
                                                    <th>Total</th>
                                                    <th></th>
                                                    <th><input type="text" name="total_wr_processing_capacity" value="{{$getProducer->total_wr_processing_capacity?$getProducer->total_wr_processing_capacity:'0'}}" class="form-control @error('total_wr_processing_capacity') is-invalid @enderror">
                                                    </th>
                                                </tr>
                                            </tfoot>
                                        </table> 
                            ...
                            <div class="row">
                                ...
                                <table id="cuttingReverting-table" class="table table-border table-striped">
                                            ...
                                            <tr class="info">
                                                @if(isset($sections[6]->custom_fields) && count($sections[6]->custom_fields))
                                                    @foreach($sections[6]->custom_fields as $key =>$column)
                                                    <th>
                                                    <input type="text" name="sections[6][custom_fields][name][]" value="@if(old('sections.6.custom_fields.name.{{$key}}')) {{old('sections.6.custom_fields.name.$key')}} @else {{$column->name}} @endif" class="form-control @error('sections.6.custom_fields.name.{{$key}}') is-invalid @enderror ">
                                                    <input type="hidden" name="sections[6][custom_fields][type][]" value="@if(old('sections.6.custom_fields.type.{{$key}}')) {{old('sections.6.custom_fields.type.$key')}} @else {{$column->type?$column->type:''}} @endif" class="form-control">
                                                    <input type="hidden" name="sections[6][custom_fields][item_list][]" value="@if(old('sections.6.custom_fields.item_list.{{$key}}')) {{old('sections.6.custom_fields.item_list.$key')}} @else NULL @endif" class="form-control">
                                                    </th>
                                                    @endforeach
                                                @else
                                                <th>      
                                            ...
                                            <tbody>
                                            @if(isset($sections[6]->custom_rows) && count($sections[6]->custom_rows))
                                                @foreach($sections[6]->custom_rows as $key=>$customRow)
                                                <tr>
                                                    @if(isset($customRow->customdata) && count($customRow->customdata))
                                                        @foreach($customRow->customdata as $keyOfCustomColumn=>$customdata)
                                                            <td><input type="text" name="sections[6][custom_rows][customdata][{{$keyOfCustomColumn}}][value][]" value="{{$customdata->value?$customdata->value:''}}" class="form-control" > </td>
                                                        @endforeach
                                                    @endif 
                                                </tr>
                                                @endforeach
                                            ...
                                            <tfoot>
                                                <tr class="info">
                                                    <th>Total</th>
                                                    <th></th>
                                                    <th><input type="text" name="total_cutting_capacity" value="{{$getProducer->total_cutting_capacity?$getProducer->total_cutting_capacity:'0'}}" class="form-control @error('total_cutting_capacity') is-invalid @enderror"></th>
                                                    <th></th>
                                                </tr>
                                            </tfoot>
                                        </table>
                            ...
                            <div class="row">
                                ...
                                <table  id="cuttingSize-table" class="table table-border table-striped">
                                    <thead>
                                    <tr class="info">
                                        @if(isset($sections[7]->custom_fields) && count($sections[7]->custom_fields))
                                            @foreach($sections[7]->custom_fields as $key =>$column)
                                            <th>
                                            <input type="text" name="sections[7][custom_fields][name][]" value="@if(old('sections.7.custom_fields.name.{{$key}}')) {{old('sections.7.custom_fields.name.$key')}} @else {{$column->name}} @endif" class="form-control @error('sections.7.custom_fields.name.{{$key}}') is-invalid @enderror ">
                                            <input type="hidden" name="sections[7][custom_fields][type][]" value="@if(old('sections.7.custom_fields.type.{{$key}}')) {{old('sections.7.custom_fields.type.$key')}} @else {{$column->type?$column->type:''}} @endif" class="form-control">
                                            <input type="hidden" name="sections[7][custom_fields][item_list][]" value="@if(old('sections.7.custom_fields.item_list.{{$key}}')) {{old('sections.7.custom_fields.item_list.$key')}} @else NULL @endif" class="form-control">
                                            </th>
                                            @endforeach
                                        @else
                                        <th>
                                    ...
                                    <tbody>
                                        @if(isset($sections[7]->custom_rows) && count($sections[6]->custom_rows))
                                            @foreach($sections[7]->custom_rows as $key=>$customRow)
                                            <tr>
                                                @if(isset($customRow->customdata) && count($customRow->customdata))
                                                    @foreach($customRow->customdata as $keyOfCustomColumn=>$customdata)
                                                        <td><input type="text" name="sections[7][custom_rows][customdata][{{$keyOfCustomColumn}}][value][]" value="{{$customdata->value?$customdata->value:''}}" class="form-control" > </td>
                                                    @endforeach
                                                @endif 
                                            </tr>
                                            @endforeach
                            ...
                            <div class="row">
                                ...
                                <table id="freezingBatch-table" class="table table-border table-striped">
                                    <thead>
                                    <tr class="info">
                                        @if(isset($sections[8]->custom_fields) && count($sections[7]->custom_fields))
                                            @foreach($sections[8]->custom_fields as $key =>$column)
                                            <th>
                                            <input type="text" name="sections[8][custom_fields][name][]" value="@if(old('sections.8.custom_fields.name.{{$key}}')) {{old('sections.8.custom_fields.name.$key')}} @else {{$column->name}} @endif" class="form-control @error('sections.8.custom_fields.name.{{$key}}') is-invalid @enderror ">
                                            <input type="hidden" name="sections[8][custom_fields][type][]" value="@if(old('sections.8.custom_fields.type.{{$key}}')) {{old('sections.8.custom_fields.type.$key')}} @else {{$column->type?$column->type:''}} @endif" class="form-control">
                                            <input type="hidden" name="sections[8][custom_fields][item_list][]" value="@if(old('sections.8.custom_fields.item_list.{{$key}}')) {{old('sections.8.custom_fields.item_list.$key')}} @else NULL @endif" class="form-control">
                                            </th>
                                            @endforeach
                                        @else
                                        <th>
                                    ...
                                    <tbody>
                                        @if(isset($sections[8]->custom_rows) && count($sections[8]->custom_rows))
                                            @foreach($sections[8]->custom_rows as $key=>$customRow)
                                            <tr>
                                                @if(isset($customRow->customdata) && count($customRow->customdata))
                                                    @foreach($customRow->customdata as $keyOfCustomColumn=>$customdata)
                                                        @if($keyOfCustomColumn=='1')
                                                        <td>
                                                            <select class="form-control" name="sections[8][custom_rows][customdata][{{$keyOfCustomColumn}}][value][]">
                                                                <option @if(isset($customdata->value) && $customdata->value=='') selected @endif value="">-- Select --</option>
                                                                <option @if(isset($customdata->value) && $customdata->value=='1') selected @endif value="1">Static IQF</option>
                                                                <option @if(isset($customdata->value) && $customdata->value=='2') selected @endif value="2">Blast Freezer</option>
                                                                <option @if(isset($customdata->value) && $customdata->value=='3') selected @endif value="3">Plaste Freezer</option>
                                                            </select>
                                                        </td>
                                                        @elseif($keyOfCustomColumn=='2')
                                                        <td>
                                                            <select class="form-control" name="sections[8][custom_rows][customdata][{{$keyOfCustomColumn}}][value][]">
                                                                <option @if(isset($customdata->value) && $customdata->value=='') selected @endif value="">-- Select --</option>
                                                                <option @if(isset($customdata->value) && $customdata->value=='1') selected @endif value="1">Loose In Plate</option>
                                                                <option @if(isset($customdata->value) && $customdata->value=='2') selected @endif value="2">Metal Pan</option>
                                                                <option @if(isset($customdata->value) && $customdata->value=='3') selected @endif value="3">Plastic crate</option>
                                                                <option @if(isset($customdata->value) && $customdata->value=='4') selected @endif value="4">carton</option>
                                                            </select> 
                                                        </td>
                                                        @else
                                                        <td><input type="text" name="sections[8][custom_rows][customdata][{{$keyOfCustomColumn}}][value][]" value="{{$customdata->value?$customdata->value:''}}" class="form-control" > </td>
                                                        @endif
                                                    @endforeach
                                                @endif 
                                    ...
                                    <tfoot>
                                        <tr class="info">
                                            ...
                                            <td></td>   
                                            <td></td>   
                                            <td><input type="text" name="total_batch_freezing_capacity" value="{{$getProducer->total_batch_freezing_capacity?$getProducer->total_batch_freezing_capacity:'0'}}" class="form-control @error('total_batch_freezing_capacity') is-invalid @enderror"> </td>   
                                        </tr>
                                    </tfoot>
                                    </table>
                                    <div class="new_rows_button">
                            ...
                            <div class="row">
                                ...
                                <table  id="freezingCountinous-table" class="table table-border table-striped">
                                    <thead>
                                    <tr class="info">
                                        @if(isset($sections[9]->custom_fields) && count($sections[9]->custom_fields))
                                            @foreach($sections[9]->custom_fields as $key =>$column)
                                            <th>
                                            <input type="text" name="sections[9][custom_fields][name][]" value="@if(old('sections.9.custom_fields.name.{{$key}}')) {{old('sections.9.custom_fields.name.$key')}} @else {{$column->name}} @endif" class="form-control @error('sections.9.custom_fields.name.{{$key}}') is-invalid @enderror ">
                                            <input type="hidden" name="sections[9][custom_fields][type][]" value="@if(old('sections.9.custom_fields.type.{{$key}}')) {{old('sections.9.custom_fields.type.$key')}} @else {{$column->type?$column->type:''}} @endif" class="form-control">
                                            <input type="hidden" name="sections[9][custom_fields][item_list][]" value="@if(old('sections.9.custom_fields.item_list.{{$key}}')) {{old('sections.9.custom_fields.item_list.$key')}} @else NULL @endif" class="form-control">
                                            </th>
                                            @endforeach
                                        @else
                                        <th>
                                    ...
                                    <tbody>
                                        @if(isset($sections[9]->custom_rows) && count($sections[9]->custom_rows))
                                            @foreach($sections[9]->custom_rows as $key=>$customRow)
                                            <tr>
                                                @if(isset($customRow->customdata) && count($customRow->customdata))
                                                    @foreach($customRow->customdata as $keyOfCustomColumn=>$customdata)
                                                        @if($keyOfCustomColumn=='1')
                                                        <td>
                                                            <select class="form-control" name="sections[9][custom_rows][customdata][{{$keyOfCustomColumn}}][value][]">
                                                                <option @if(isset($customdata->value) && $customdata->value=='') selected @endif value="">-- Select --</option>
                                                                <option @if(isset($customdata->value) && $customdata->value=='1') selected @endif value="1">Static IQF</option>
                                                                <option @if(isset($customdata->value) && $customdata->value=='2') selected @endif value="2">Blast Freezer</option>
                                                                <option @if(isset($customdata->value) && $customdata->value=='3') selected @endif value="3">Plaste Freezer</option>
                                                        ...
                                                        @else
                                                        <td><input type="text" name="sections[9][custom_rows][customdata][{{$keyOfCustomColumn}}][value][]" value="{{$customdata->value?$customdata->value:''}}" class="form-control" > </td>
                                                        @endif
                                                    @endforeach
                                                @endif 
                            ...
                            <div class="row">
                                ...
                                <table id="storage-table" class="table table-border table-striped">
                                    <thead>
                                    <tr class="info">
                                        @if(isset($sections[10]->custom_fields) && count($sections[10]->custom_fields))
                                            @foreach($sections[10]->custom_fields as $key =>$column)
                                            <th>
                                            <input type="text" name="sections[10][custom_fields][name][]" value="@if(old('sections.10.custom_fields.name.{{$key}}')) {{old('sections.10.custom_fields.name.$key')}} @else {{$column->name}} @endif" class="form-control @error('sections.10.custom_fields.name.{{$key}}') is-invalid @enderror ">
                                            <input type="hidden" name="sections[10][custom_fields][type][]" value="@if(old('sections.10.custom_fields.type.{{$key}}')) {{old('sections.10.custom_fields.type.$key')}} @else {{$column->type?$column->type:''}} @endif" class="form-control">
                                            <input type="hidden" name="sections[10][custom_fields][item_list][]" value="@if(old('sections.10.custom_fields.item_list.{{$key}}')) {{old('sections.10.custom_fields.item_list.$key')}} @else NULL @endif" class="form-control">
                                            </th>
                                            @endforeach
                                        @else
                                        <th>
                                    ...
                                    <tbody>
                                        @if(isset($sections[10]->custom_rows) && count($sections[10]->custom_rows))
                                            @foreach($sections[10]->custom_rows as $key=>$customRow)
                                            <tr>
                                                @if(isset($customRow->customdata) && count($customRow->customdata))
                                                    @foreach($customRow->customdata as $keyOfCustomColumn=>$customdata)
                                                        @if($keyOfCustomColumn=='2')
                                                        <td>
                                                            <select class="form-control" name="sections[10][custom_rows][customdata][{{$keyOfCustomColumn}}][value][]">
                                                                <option @if(isset($customdata->value) && $customdata->value=='') selected @endif value="">-- Select --</option>
                                                                <option @if(isset($customdata->value) && $customdata->value=='1') selected @endif value="1">Cold Store</option>
                                                                <option @if(isset($customdata->value) && $customdata->value=='2') selected @endif value="2">Container plug</option>
                                                            </select>
                                                        </td>
                                                        @else
                                                        <td><input type="text" name="sections[10][custom_rows][customdata][{{$keyOfCustomColumn}}][value][]" value="{{$customdata->value?$customdata->value:''}}" class="form-control" > </td>
                                                        @endif
                                                    @endforeach
                                                @endif 
                                ...
                                <div class="col-md-11 table-responsive">
                                    <table id="expedition-table" class="table table-border table-striped table-hover">
                                       ...
                                       <tr class="info">
                                        ...
                                        <tbody>
                                        @if(isset($userExpedition) && count($userExpedition))
                                            @foreach($userExpedition as $userExp)
                                            <tr>
                                               <th class="info"><input type="text" name="expedition[key][]" value="{{$userExp->key}}" class="form-control @error('expedition.key.0') is-invalid @enderror"></th>
                                               <td><input type="text"   name="expedition[value][]" value="{{$userExp->value}}" class="form-control @error('expedition.value.0') is-invalid @enderror" ></td>
                                            </tr>
                                            @endforeach
                                        @else
                                           <tr>
                            ...
                            <div class="row">
                                ...
                                <table  id="transportation-table" class="table table-border table-striped">
                                    <thead>
                                    <tr class="info">
                                        @if(isset($sections[11]->custom_fields) && count($sections[11]->custom_fields))
                                            @foreach($sections[11]->custom_fields as $key =>$column)
                                            <th>
                                            <input type="text" name="sections[11][custom_fields][name][]" value="@if(old('sections.11.custom_fields.name.{{$key}}')) {{old('sections.11.custom_fields.name.$key')}} @else {{$column->name}} @endif" class="form-control @error('sections.11.custom_fields.name.{{$key}}') is-invalid @enderror ">
                                            <input type="hidden" name="sections[11][custom_fields][type][]" value="@if(old('sections.11.custom_fields.type.{{$key}}')) {{old('sections.11.custom_fields.type.$key')}} @else {{$column->type?$column->type:''}} @endif" class="form-control">
                                            <input type="hidden" name="sections[11][custom_fields][item_list][]" value="@if(old('sections.11.custom_fields.item_list.{{$key}}')) {{old('sections.11.custom_fields.item_list.$key')}} @else NULL @endif" class="form-control">
                                            </th>
                                            @endforeach
                                        @else
                                        <th>
                                    ...
                                    <tbody>
                                        @if(isset($sections[11]->custom_rows) && count($sections[11]->custom_rows))
                                            @foreach($sections[11]->custom_rows as $key=>$customRow)
                                            <tr>
                                                @if(isset($customRow->customdata) && count($customRow->customdata))
                                                    @foreach($customRow->customdata as $keyOfCustomColumn=>$customdata)
                                                        <td><input type="text" name="sections[11][custom_rows][customdata][{{$keyOfCustomColumn}}][value][]" value="{{$customdata->value?$customdata->value:''}}" class="form-control" > </td>
                                                    @endforeach
                                                @endif 
                            ...
                            <div class="row">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <label>
                                            <input type="radio" class="flat-red @error('auditInfo.is_factory_approved') is-invalid @enderror" name="auditInfo[is_factory_approved]" value="1" @if($userAudit->is_factory_approved == '1') checked @endif > Yes
                                            </label>
                                            <label>
                                            <input type="radio" class="flat-red @error('auditInfo.is_factory_approved') is-invalid @enderror" name="auditInfo[is_factory_approved]" value="0" @if( $userAudit->is_factory_approved == '0') checked @endif> No
                                            </label>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="auditInfo[audit_date]" id="audit_date" value="{{ $userAudit->audit_date }}" class="form-control @error('auditInfo.audit_date') is-invalid @enderror" > </td>
                                    </tr>
                                    <tr>
                                        <th><label for="code">Global Scoring </label></th> 
                                        <td><input type="text" name="auditInfo[scoring]" id="scoring" value="{{ $userAudit->scoring }}" class="form-control @error('auditInfo.scoring') is-invalid @enderror" > </td>
                                    </tr>
                                    <tr>
                                        <th><label for="code">Row Material </label></th> 
                                        <td><input type="text" name="auditInfo[row_material]" value="{{ $userAudit->row_material }}" id="row_material" class="form-control @error('auditInfo.row_material') is-invalid @enderror" 
                                        > </td>
                                    </tr>
                                    <tr>
                                        <th><label for="code">Processing facilities </label></th> 
                                        <td><input type="text" name="auditInfo[processing_facilities]" value="{{ $userAudit->processing_facilities }}" id="processing_facilities" class="form-control @error('auditInfo.processing_facilities') is-invalid @enderror" > </td>
                                    </tr>
                                    <tr>
                                        <th><label for="code"> Respect of the cold chain </label></th>
                                        <td><input type="text" name="auditInfo[respect_cold_chain]" value="{{ $userAudit->respect_cold_chain }}" id="respect_cold_chain" class="form-control @error('auditInfo.respect_cold_chain') is-invalid @enderror" > </td>
                                    </tr>
                                    <tr>
                                        <th><label for="code"> Storage </label></th>
                                        <td><input type="text" name="auditInfo[storage]" value="{{ $userAudit->storage }}" class="form-control @error('auditInfo.storage') is-invalid @enderror" 
                                        > </td>
                                    </tr>
                                    <tr>
                                        <th><label for="code"> Traceability </label></th>
                                        <td><input type="text" name="auditInfo[traceability]" value="{{ $userAudit->traceability }}" class="form-control @error('auditInfo.traceability') is-invalid @enderror" > </td>
                                    </tr>
                                </tbody>
                                </table>
                                </div>  
                    ...
                    <div class="tab-pane @if(Session::has('tab') && Session::get('tab')=='tab_2') active @endif" id="tab_2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                @if(isset($getProducer->profileImage->file)) 
                                    <img src="{{asset('userImages/'.$getProducer->profileImage->file)}}"  alt="image path not found " srcset="" style="height:100px; width: 80px;">
                                @endif
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">    
                                @if(isset($userSettings['wr_fish_online_qc']))
                                    @if($userSettings['wr_fish_online_qc']=='1')
                                        <input type="checkbox" name="wr_fish_online_qc" class="minimal" value="{{ $userSettings['wr_fish_online_qc'] }}" checked/>
                                    @endif
                                    @else
                                        <input type="checkbox" name="wr_fish_online_qc" class="minimal form_control"/>
                                @endif   
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                @if(isset($userSettings['cut_fish_online_qc']))
                                    @if($userSettings['cut_fish_online_qc']=='1')
                                    <input type="checkbox" name="cut_fish_online_qc" value="{{ $userSettings['cut_fish_online_qc'] }}" class="minimal form_control" checked>
                                @endif
                                @else
                                    <input type="checkbox" name="cut_fish_online_qc" class="minimal form_control">
                                @endif
                            ...
                            <div class="col-md-12">
                                <table class="table table-border table-striped">
                                   ...
                                   <tbody>
                                        <tr>
                                            <td>
                                                <input type="checkbox" name="combined_wr" class="minimal form_control" checked>
                                                <label for="">Combined WR Fish</label>
                                            </td>
                                            <td>
                                                <input type="checkbox" name="combined_cut" class="minimal form_control" checked>
                                                <label for="email">Combined Cut Fish</label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            @if(isset($requestedItem->raw_wr_weight_is_checked))
                                                @if($requestedItem->raw_wr_weight_is_checked=='1')
                                                <input type="checkbox" name="raw_wr_weight_is_checked" value="{{ $requestedItem->raw_wr_weight_is_checked }}" class="minimal form_control" checked>
                                            @endif
                                            @else
                                                <input type="checkbox" name="raw_wr_weight_is_checked" class="minimal form_control">
                                            @endif   
                                                <label for="raw_wr_weight">Weight:min</label>
                                                <input type="text" name="raw_wr_weight" value="{{ $requestedItem->raw_wr_weight }}" class="input130">
                                            </td>
                                            <td>
                                            @if(isset($requestedItem->raw_cut_fish_weight_is_checked))
                                              @if($requestedItem->raw_cut_fish_weight_is_checked=='1')
                                                <input type="checkbox" name="raw_cut_fish_weight_is_checked" value="{{ $requestedItem->raw_cut_fish_weight_is_checked }}" class="minimal form_control" checked>
                                            @endif
                                            @else
                                            ...
                                            @endif   
                                                ...
                                                <input type="text" name="raw_cut_fish_weight" value="{{ $requestedItem->raw_cut_fish_weight }}" class="input130">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            @if(isset($requestedItem->raw_wr_length_is_checked))
                                               @if($requestedItem->raw_wr_length_is_checked=='1')
                                                <input type="checkbox" name="raw_wr_length_is_checked" value="{{ $requestedItem->raw_wr_length_is_checked }}" class="minimal form_control" checked>
                                            @endif
                                            @else
                                            <input type="checkbox" name="raw_wr_length_is_checked" class="minimal form_control">
                                            @endif    
                                                <label for="raw_wr_length">Length:min</label>
                                                <input type="text" name="raw_wr_length" value="{{ $requestedItem->raw_wr_length }}" class="input130">
                                            </td>
                                            <td>
                                            @if($requestedItem->raw_cut_fish_length_is_checked)
                                               @if($requestedItem->raw_cut_fish_length_is_checked=='1')
                                                <input type="checkbox" name="raw_cut_fish_length_is_checked" value="{{ $requestedItem->raw_cut_fish_length_is_checked }}" class="minimal form_control" checked>
                                            @endif
                                            @else
                                            ...
                                            @endif   
                                                ...
                                                <input type="text" name="raw_cut_fish_length" value="{{ $requestedItem->raw_cut_fish_length }}" class="input130">
                                            </td>
                                        </tr>
                                   </tbody>
                                </table>
                            ...
                            <div class="col-md-12">
                                <table class="table table-border table-striped">
                                   ...
                                   <tbody>
                                        <tr>
                                            <td>
                                                <input type="checkbox" name="combined_fish_wr" class="minimal form_control" checked>
                                                <label for="company">Combined WR Fish</label>
                                            </td>
                                            <td>
                                                <input type="checkbox" name="combined_cut_fish" class="minimal form_control" checked>
                                                <label for="email">Combined Cut Fish</label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            @if($requestedItem->finished_product_wr_weight_is_checked)
                                                @if($requestedItem->finished_product_wr_weight_is_checked=='1')
                                                <input type="checkbox" name="finished_product_wr_weight_is_checked" value="{{ $requestedItem->finished_product_wr_weight_is_checked }}" class="minimal form_control" checked>
                                            @endif
                                            @else
                                            ...
                                            @endif   
                                                ...
                                                <input type="text" name="finished_product_wr_weight" value="{{ $requestedItem->finished_product_wr_weight }}" class="input130">
                                            </td>
                                            <td>
                                            @if($requestedItem->finished_product_cut_fish_weight_is_checked)
                                               @if($requestedItem->finished_product_cut_fish_weight_is_checked=='1')
                                                <input type="checkbox" name="finished_product_cut_fish_weight_is_checked" value="{{ $requestedItem->finished_product_cut_fish_weight_is_checked }}" class="minimal form_control" checked>
                                            @endif
                                            @else
                                            ...
                                            @endif   
                                                ...
                                                <input type="text" name="finished_product_cut_fish_weight" value="{{ $requestedItem->finished_product_cut_fish_weight }}" class="input130">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            @if($requestedItem->finished_product_wr_length_is_checked)
                                               @if($requestedItem->finished_product_wr_length_is_checked=='1')
                                                <input type="checkbox" name="finished_product_wr_length_is_checked" value="{{ $requestedItem->finished_product_wr_length_is_checked }}" class="minimal form_control" checked>
                                            @endif
                                            @else
                                            ...
                                            @endif   
                                                ...
                                                <input type="text" name="finished_product_wr_length" value="{{ $requestedItem->finished_product_wr_length }}" class="input130">
                                            </td>
                                            <td>
                                            @if($requestedItem->finished_product_cut_fish_length_is_checked)
                                               @if($requestedItem->finished_product_cut_fish_length_is_checked=='1')
                                                <input type="checkbox" name="finished_product_cut_fish_length_is_checked" value="{{ $requestedItem->finished_product_cut_fish_length_is_checked }}"  class="minimal form_control" checked>
                                            @endif
                                            @else
                                            ...
                                            @endif    
                                                ...
                                                <input type="text" name="finished_product_cut_fish_length" value="{{ $requestedItem->finished_product_cut_fish_length }}" class="input130">
                                            </td>
                                        </tr>
                                   </tbody>
                                </table>
                        ...
                        <div class="row">
                           <div class="col-md-12">
                                <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                            @if(isset($customization['temperature_ckeck_reminder_timescale']))
                                                <input type="radio" name="temperature_ckeck_reminder_timescale" class="flat-red" value="1" @if( $customization['temperature_ckeck_reminder_timescale'] == '1') checked @endif> 
                                            @endif
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                            @if(isset($customization['temperature_ckeck_reminder_timescale']))
                                                <input type="radio" name="temperature_ckeck_reminder_timescale" class="flat-red" value="2" @if( $customization['temperature_ckeck_reminder_timescale'] == '2') checked @endif >
                                            @endif
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                            @if(isset($customization['temperature_ckeck_reminder_timescale']))
                                                    <input type="radio" name="temperature_ckeck_reminder_timescale" class="flat-red" value="3"  @if( $customization['temperature_ckeck_reminder_timescale'] == '3') checked @endif > 
                                                @endif 
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                            @if(isset($customization['temperature_ckeck_reminder_timescale']))
                                                <input type="radio" name="temperature_ckeck_reminder_timescale" class="flat-red" value="4"  @if( $customization['temperature_ckeck_reminder_timescale'] == '4') checked @endif >
                                            @endif 
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                            @if(isset($customization['temperature_ckeck_reminder_timescale']))
                                                <input type="radio" name="temperature_ckeck_reminder_timescale" class="flat-red" value="5"  @if( $customization['temperature_ckeck_reminder_timescale'] == '5') checked @endif > 
                                            @endif 
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                            @if(isset($customization['temperature_ckeck_reminder_timescale']))
                                                <input type="radio" name="temperature_ckeck_reminder_timescale" class="flat-red" value="6"  @if( $customization['temperature_ckeck_reminder_timescale'] == '6') checked @endif >
                                            @endif
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                            @if(isset($customization['temperature_ckeck_reminder_timescale']))
                                                <input type="radio" name="temperature_ckeck_reminder_timescale" class="flat-red" value="7" @if( $customization['temperature_ckeck_reminder_timescale'] == '7') checked @endif > 
                                            @endif 
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                @if(isset($customization->custom_reminder_timescale_day))
                                                <input type="text" name="custom_reminder_timescale_day" value="{{ $customization->custom_reminder_timescale_day }}"  onkeypress="return restrictAlphabets(event)" class="input130" >
                                                @endif
                                            </div>
                                        </div>
                                    </div> <!--  END Row -->
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                @if(isset($customization['minimum_temperature']))
                                    <input type="radio" name="minimum_temperature" class="flat-red" value="1"  @if( $customization['minimum_temperature'] == '1') checked @endif> 
                                @endif  
                                    <label> -23 &#8451; </label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                @if(isset($customization['minimum_temperature']))
                                    <input type="radio" name="minimum_temperature"  class="flat-red" checked value="2" @if( $customization['minimum_temperature']  == '2') checked @endif>
                                @endif  
                                    <label> -24 &#8451; </label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                @if(isset($customization['minimum_temperature']))
                                    <input type="radio" name="minimum_temperature"  class="flat-red" value="3"  @if( $customization['minimum_temperature']  == '3') checked @endif> 
                                @endif 
                                    <label> -25 &#8451; </label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                @if(isset($customization['minimum_temperature']))
                                    <input type="radio" name="minimum_temperature" class="flat-red" value="4"  @if( $customization['minimum_temperature']  == '4') checked @endif> 
                                @endif 
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                <label>&#8451;</label>
                                @if(isset($customization->other_minimum_temperature))
                                <input type="text" name="other_minimum_temperature" value="{{ $customization->other_minimum_temperature }}" onkeypress="return restrictAlphabets(event)" class="input130">
                                @endif 
                                </div>
                            </div>
                        </div> <!--  END Row -->
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label> 15 min </label>
                                    @if(isset( $customization['continuous_freezing']))
                                    <input type="radio" name="continuous_freezing"  class="flat-red" value="1" @if( $customization['continuous_freezing'] == '1') checked @endif> 
                                    @else
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label> 30 min </label>
                                    @if(isset( $customization['continuous_freezing']))
                                    <input type="radio" name="continuous_freezing"  class="flat-red" value="2" @if(  $customization['continuous_freezing'] == '2') checked @endif> 
                                    @else
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label> 45 min </label>
                                    @if(isset( $customization['continuous_freezing']))
                                    <input type="radio" name="continuous_freezing"  class="flat-red" checked value="3" @if(  $customization['continuous_freezing'] == '3') checked @endif> 
                                    @else
                                    <input type="radio" name="continuous_freezing"  class="flat-red" value="3">
                                   @endif
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label> 1 hour </label>
                                    @if(isset( $customization['continuous_freezing']))
                                    <input type="radio" name="continuous_freezing"  class="flat-red" value="4" @if(  $customization['continuous_freezing'] == '4') checked @endif> 
                                    @else
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    @if(isset( $customization['continuous_freezing']))
                                    <input type="radio" name="continuous_freezing"  class="flat-red" value="5" @if(  $customization['continuous_freezing'] == '5') checked @endif> 
                                    @else
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label> hour </label>
                                    @if(isset( $customization->other_continuous_freezing))
                                    <input type="text" name="other_continuous_freezing" value="{{ $customization->other_continuous_freezing }}" onkeypress="return restrictAlphabets(event)"  class="input130">
                                   @else
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                @if(isset($customization['weight_calibration']))
                                    <input type="radio" checked name="weight_calibration" id="yes" class="flat-red" value="1"  @if( $customization['weight_calibration'] == '1') checked @endif>
                                @else
                            ...
                            <div class="col-md-6"> 
                               <div class="form-group">
                                @if(isset($customization['weight_calibration']))
                                    <input type="radio" name="weight_calibration" id="no" class="flat-red" value="0" @if( $customization['weight_calibration'] == '0') checked @endif>
                                 @else
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                @if(isset($customization['control_frequency']))
                                    <input type="radio" name="control_frequency"  class="flat-red" value="0" @if( $customization['control_frequency'] == '0') checked @endif> 
                                @else
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                @if(isset($customization['control_frequency']))
                                    <input type="radio" name="control_frequency"  class="flat-red" value="1" @if( $customization['control_frequency'] == '1') checked @endif> 
                                    @else
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                @if(isset($customization['control_frequency']))
                                    <input type="radio" name="control_frequency"  class="flat-red" value="2" @if( $customization['control_frequency'] == '2') checked @endif> 
                                @else
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-btn"> <!-- btn-group-vertical-->
                                            ...
                                            @if(isset($customization['standard_drip_loss_value']))
                                            <input type="hidden"  name="standard_drip_loss_value" value="{{ $customization['standard_drip_loss_value'] }}"/>
                                            <button type="button" class="btn btn-default standard-value-lable">{{ $customization['standard_drip_loss_value'] }}%</button>
                                            @endif
                            ...
                            <div class="col-md-6"> 
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-btn"> <!-- btn-group-vertical-->
                                            <button type="button" class="btn btn-default standard-btn-minus"><span class="glyphicon glyphicon-minus"></span></button>
                                            @if(isset($customization['standard_guts_weight']))
                                            <input type="hidden"  name="standard_guts_weight" value="{{ $customization['standard_guts_weight'] }}"/>
                                            <button type="button" class="btn btn-default standard-value-lable" >{{ $customization['standard_guts_weight'] }} %</button>
                                           @endif
                                            <button type="button" class="btn btn-default standard-btn-plus"><span class="glyphicon glyphicon-plus"></span></button>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-12 table-responsive">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <input type="hidden" name="cold_chain_standard[title][]" value="{{ isset($coldChainStandard[0]['title'])?$coldChainStandard[0]['title']:'' }}">
                                        <td><input type="text" name="cold_chain_standard[target_value][]" value="{{ isset($coldChainStandard[0]['target_value'])?$coldChainStandard[0]['target_value']:'' }}" onkeypress="return restrictAlphabets(event)" class="form-control" > </td>
                                        <td><input type="text" name="cold_chain_standard[border_value][]" value="{{ isset($coldChainStandard[0]['border_value'])?$coldChainStandard[0]['border_value']:'' }}" onkeypress="return restrictAlphabets(event)" class="form-control" > </td>
                                    
                                    </tr>
                                    <tr>
                                        <th><label for="code">Unloading </label></th> 
                                        <input type="hidden" name="cold_chain_standard[title][]" value="{{ isset($coldChainStandard[1]['title'])?$coldChainStandard[1]['title']:'' }}">
                                        <td><input type="text" name="cold_chain_standard[target_value][]" value="{{ isset($coldChainStandard[1]['target_value'])?$coldChainStandard[1]['target_value']:'' }}" onkeypress="return restrictAlphabets(event)" class="form-control" > </td>
                                        <td><input type="text" name="cold_chain_standard[border_value][]" value="{{ isset($coldChainStandard[1]['border_value'])?$coldChainStandard[1]['border_value']:'' }}" onkeypress="return restrictAlphabets(event)" class="form-control" > </td>
                                    </tr>
                                    <tr>
                                        <th><label for="code">Transport</label></th> 
                                        <input type="hidden" name="cold_chain_standard[title][]" value="{{ isset($coldChainStandard[2]['title'])?$coldChainStandard[2]['title']:'' }}">
                                        <td><input type="text" name="cold_chain_standard[target_value][]" value="{{ isset($coldChainStandard[2]['target_value'])?$coldChainStandard[2]['target_value']:'' }}" onkeypress="return restrictAlphabets(event)" class="form-control" > </td>
                                        <td><input type="text" name="cold_chain_standard[border_value][]" value="{{ isset($coldChainStandard[2]['border_value'])?$coldChainStandard[2]['border_value']:'' }}" onkeypress="return restrictAlphabets(event)" class="form-control" > </td>
                                    </tr>
                                    <tr>
                                        <th><label for="code">Reception </label></th> 
                                        <input type="hidden" name="cold_chain_standard[title][]" value="{{ isset($coldChainStandard[3]['title'])?$coldChainStandard[3]['title']:'' }}">
                                        <td><input type="text" name="cold_chain_standard[target_value][]" value="{{ isset($coldChainStandard[3]['target_value'])?$coldChainStandard[3]['target_value']:'' }}" onkeypress="return restrictAlphabets(event)" class="form-control" > </td>
                                        <td><input type="text" name="cold_chain_standard[border_value][]" value="{{ isset($coldChainStandard[3]['border_value'])?$coldChainStandard[3]['border_value']:'' }}" onkeypress="return restrictAlphabets(event)" class="form-control" > </td>
                                    </tr>
                                    <tr>
                                        <th><label for="code"> Production </label></th>
                                        <input type="hidden" name="cold_chain_standard[title][]" value="{{ isset($coldChainStandard[4]['title'])?$coldChainStandard[4]['title']:'' }}">
                                        <td><input type="text" name="cold_chain_standard[target_value][]" value="{{ isset($coldChainStandard[4]['target_value'])?$coldChainStandard[4]['target_value']:'' }}" onkeypress="return restrictAlphabets(event)" class="form-control" > </td>
                                        <td><input type="text" name="cold_chain_standard[border_value][]" value="{{ isset($coldChainStandard[4]['border_value'])?$coldChainStandard[4]['border_value']:'' }}" onkeypress="return restrictAlphabets(event)" class="form-control" > </td>
                                    </tr>
                                    <tr>
                                        <th><label for="code"> Freezing </label></th>
                                        <input type="hidden" name="cold_chain_standard[title][]" value="{{ isset($coldChainStandard[5]['title'])?$coldChainStandard[5]['title']:'' }}">
                                        <td><input type="text" name="cold_chain_standard[target_value][]" value="{{ isset($coldChainStandard[5]['target_value'])?$coldChainStandard[5]['target_value']:'' }}" onkeypress="return restrictAlphabets(event)" class="form-control" > </td>
                                        <td><input type="text" name="cold_chain_standard[border_value][]" value="{{ isset($coldChainStandard[5]['border_value'])?$coldChainStandard[5]['border_value']:'' }}" onkeypress="return restrictAlphabets(event)" class="form-control" > </td>
                                    </tr>
                                    <tr>
                                        <th><label for="code"> Storage </label></th>
                                        <input type="hidden" name="cold_chain_standard[title][]"  value="{{ isset($coldChainStandard[6]['title'])?$coldChainStandard[6]['title']:'' }}">
                                        <td><input type="text" name="cold_chain_standard[target_value][]"  value="{{ isset($coldChainStandard[6]['target_value'])?$coldChainStandard[6]['target_value']:'' }}" onkeypress="return restrictAlphabets(event)" class="form-control" > </td>
                                        <td><input type="text" name="cold_chain_standard[border_value][]"  value="{{ isset($coldChainStandard[6]['border_value'])?$coldChainStandard[6]['border_value']:'' }}" onkeypress="return restrictAlphabets(event)" class="form-control" > </td>
                                    </tr>
                                </tbody>
                                </table>
                            </div>  
                        </div> <!--  END Row -->
                        <button type="submit" class="btn btn-primary updateCustomizationButton">Update Customization</button>
                       </form>
                    </div><!-- /.tab-pane -->


                    <div class="tab-pane @if(Session::has('tab') && Session::get('tab')=='tab_3') active @endif" id="tab_3">
                       <form action="{{ url('accountmanagement/updateSpecificationSop') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <table class="table spec-table table-border table-striped">
                                    ...
                                    @if(isset($getAllSpecTypes) && count($getAllSpecTypes))
                                        @foreach($getAllSpecTypes as $row)
                                            <tr>
                                                <td>
                                                    <input type="checkbox" name="makeral" id="sardineSpec" class="minimal" value="check">  
                                                ...
                                                <tbody>
                                                <tr>
                                                        <td><input type="checkbox" name="discrepancies[is_checked][]" class="minimal" value="1" />
                                                        <label for="company">Mechanical Damage</label>
                                                        <input type="hidden" name="discrepancies[discrepancy_id][]" value="1">
                                                        <input type="hidden" name="discrepancies[discrepancies][]" value="Mechanical Damage">
                                                        <input type="hidden" name="discrepancies[discrepancy_key][]" value="mechanicalDamage">
                                                        <input type="hidden" name="discrepancies[unit][]" value="%">
                                                        <input type="hidden" name="discrepancies[type][]" value="1">
                                                        </td>
                                                        <td> 
                                                        <div class="row"> 
                                                            <div class="col-md-6"> 
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                        <div class="input-group-btn"> <!-- btn-group-vertical-->
                                                                            ...
                                                                            <input type="hidden" class="offset-input-value" name="discrepancies[rejection_offset_value][]" value="0">
                                                                            <input type="hidden" class="input-value" name="discrepancies[rejection_value][]" value="100">
                                                                            <button type="button" class="btn btn-default text-red offset-label rejection_offset_value">0 %</button>
                                                                            <button type="button" class="btn btn-default value-label rejection_value">100</button>
                                                            ...
                                                            <div class="col-md-6"> 
                                                                <div class="form-group">
                                                                    <div class="input-group">
                                                                        <div class="input-group-btn"> <!-- btn-group-vertical-->
                                                                            <button type="button" class="btn btn-default btn-minus"><span class="glyphicon glyphicon-minus"></span></button>
                                                                            <input type="hidden" class="offset-input-value" name="discrepancies[border_offset_value][]" value="0">
                                                                            <input type="hidden" class="input-value" name="discrepancies[border_value][]" value="5">
                                                                            <button type="button" class="btn btn-default text-red offset-label border_offset_value">0 %</button>
                                                                            <button type="button" class="btn btn-default value-label rejection_value">5</button>
                                                                            <button type="button" class="btn btn-default btn-plus"><span class="glyphicon glyphicon-plus"></span></button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <a href="#"> 1. HGT sardine Specification morocco pdf &nbsp;&nbsp;<span class="fa fa-trash text-danger"></span></a>
                            </div>
                            <div class="col-md-6">
                                <a href="#" class="fa fa-plus"> Add A Document</a>
                            </div>
                        </div><!--  END Row -->
                        
                        <button type="submit" class="btn btn-primary">Update Sop's</button>
 ...
 */
        ...
        $('#AddSpecTypeForm').submit(function(e){
            ...
            if($("#name").val()){
                ...
                $('#AddSpecTypeForm .ajaxError').html('<span class="text-danger">Spec Name fields is required </span>'); 
