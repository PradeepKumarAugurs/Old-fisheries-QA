...
<div class="content-wrapper">
    ...
    <section class="content">
            <h2 class="page-header">New lot/Comment</h2>
            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                  ...
                                  <input type="text" name="username" id="username" class="form-control" placeholder="Enter Lot Number">
                                </div>
                              </div>
                              <div class="col-md-6">
                                 <div class="form-group">
                                      <label for="user_image">Production Date</label>
                                      <input type="text" name="username" id="username" class="form-control" placeholder="Enter Lot Date">
                                </div>
                            </div>
                        </div> <!--  END Row -->
                        <div class="row">
